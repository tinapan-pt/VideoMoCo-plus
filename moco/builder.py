...
class Generator_Mask(nn.Module):
    """ generator for the mask:topk should be adaptive for the training process"""
...
class MoCo(nn.Module):
    ...
    def forward(self, im_q_fake, im_q, im_k, loss_gan):
        """
        Input:
        ...
        # negative logits: NxK
        weight = (1 - 1 * loss_gan) ** (1.0 * self.count).cuda()
